...
Сценарий: Закрытие Документа Обслуживание клиента Специалмст Лодочкин, 03.01.2025 с 08 по 12
...
Если таблица "Список" содержит строки: Тогда
		| 'Время начала работ (План)' | 'Время окончания работ (План)' | 'Дата проведения работ' | 'Договор'                      | 'Клиент'         |  'Специалист'     | 'Статус заявки'     |
		| '08.00'                     | '12.00'                        | '03.01.2025'            | 'Абонентское обслуживание №10' | 'Глубокое озеро' | | 'Лодочкин Л. Л.' | 'Заявка выполнена' |
...
Сценарий: Закрытие Документа Обслуживание клиента Специалмст Мопедов М. М., 04.01.2025 с 10 по 12
...
Если таблица "Список" содержит строки: Тогда
		| 'Время начала работ (План)' | 'Время окончания работ (План)' |  'Дата проведения работ' | 'Договор'                      | 'Клиент'         		|  'Специалист'     | 'Статус заявки'              |
		| '10.00'                     | '12.00'                        |  '04.01.2025'            | 'Абонентское обслуживание №12' | 'Марианская впадина' 	|  'Мопедов М. М.' 	| 'Заявка выполнена' |
...
Сценарий: Закрытие Документа Обслуживание клиента Специалист Самокатов С. С., 05.01.2025 с 10 по 15
...
Если таблица "Список" содержит строки: Тогда
		| 'Время начала работ (План)' | 'Время окончания работ (План)' |  'Дата проведения работ' | 'Договор'                      | 'Клиент'         		|  'Специалист'     | 'Статус заявки'              |
		| '10.00'                     | '15.00'                        |  '05.01.2025'            | 'Абонентское обслуживание №15' | 'ООО Райский остров' 	|  'Самокатов С. С.' 	| 'Заявка выполнена' |
